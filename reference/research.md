...
direction and intensity. Output: ranked themes (positive/negative), representative quotes, the
volume behind each, and 3-5 action items. Quantify ("38 of 120 reviews mention onboarding"), do
not just adjective-spray.
...
competitor maps include substitutes and a stated point of difference.
